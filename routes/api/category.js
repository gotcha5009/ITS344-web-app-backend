...
// @access  public
router.get("/", category_controller.getCatagories);

// @route   GET /api/category/company/:companyId
// @desc    Get all categories in company
// @access  public
router.get("/company/:companyId", category_controller.getCatagories);
